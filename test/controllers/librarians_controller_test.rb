...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference('Librarian.count') do
      post librarians_url, params: { librarian: { email: @librarian.email, library: @librarian.library, name: @librarian.name, password: @librarian.password } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { email: @librarian.email, library: @librarian.library, name: @librarian.name, password: @librarian.password } }
